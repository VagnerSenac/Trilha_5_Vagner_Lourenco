...
namespace Comex.Data
{
    public class ProdutoDAL
    {
        ...
        public void Adicionar(Produto produto)
        {
            ...
            command.Parameters.AddWithValue("@descricao", produto.DescricaoProduto);
            command.Parameters.AddWithValue("@preco", produto.PrecoProdutos);
